    ...
    return (
        ...
        <div className='register-form'>
            ...
            <form onSubmit={handleRegister}>
                ...
                <input type="password" name="password" id="" placeholder='enter your passwoed' required />
                ...
                <input
                    disabled={!agree}
                    className="btn btn-primary w-50 mx-auto d-block mb-2 mt-2" type="submit" value="Register" />
            </form>
